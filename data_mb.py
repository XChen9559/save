...
class AudioDataset(data.Dataset):
    ...
    def __init__(self, json_dir, batch_size, sample_rate=8000, segment=4.0, cv_maxlen=8.0, flag_eval = False):
        ...
        noise_json = os.path.join(json_dir, 'noise0_v2.json')
        voice_json = os.path.join(json_dir, 's1.json')
        music_json = os.path.join('/home/sr5/xi5.chen/2sep_chenxi/2sep_envs/data_3sep_filtered_part/music_48k.json')
        vocal_json = os.path.join('/home/sr5/xi5.chen/2sep_chenxi/2sep_envs/data_3sep_filtered_part/songs_acapella_split_checked.json')
        ...
        with open(vocal_json, 'r') as f:
            vocal_jsons = json.load(f)
        ...
        sorted_music_infos = sort(music_jsons)
        sorted_vocal_infos = sort(vocal_jsons)
        

        if flag_eval == True:
           sorted_music_infos = sorted_music_infos + sorted_music_infos + sorted_music_infos + sorted_music_infos + sorted_music_infos + sorted_music_infos + sorted_music_infos + sorted_music_infos + sorted_music_infos + sorted_music_infos + sorted_music_infos + sorted_music_infos + sorted_music_infos+          sorted_music_infos + sorted_music_infos + sorted_music_infos
           sorted_vocal_infos = sorted_vocal_infos +  sorted_vocal_infos +  sorted_vocal_infos
           sorted_voice_infos = sorted_voice_infos[:10000] 
           ...
           sorted_vocal_infos = sorted_vocal_infos[:10000]

           
        if flag_eval == False:
            ### instrument
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/musicdb_48k_4s/json/train/bass.json')
            with open(a_json, 'r') as f:
                bass_infos = json.load(f)
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/musicdb_48k_4s/json/train/drums.json')
            with open(a_json, 'r') as f:
                drums_infos = json.load(f)
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/musicdb_48k_4s/json/train/mixture_wovocal.json')
            with open(a_json, 'r') as f:
                mixture_wovocal_infos = json.load(f)
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/musicdb_48k_4s/json/train/other.json')
            with open(a_json, 'r') as f:
                other_infos = json.load(f)
            a_json = os.path.join('/home/sr5/xi5.chen/2sep_chenxi/2sep_envs/data_3sep_filtered_part/music_48k.json')
            with open(a_json, 'r') as f:
                music_infos = json.load(f)

            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/instrument.json')
            with open(a_json, 'r') as f:
                music_mv_infos = json.load(f)
                
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/20240202_electric_guitar_48k_4s.json')
            with open(a_json, 'r') as f:
                music_guitar_infos1 = json.load(f)
            
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/20240204_bilibili_electric_guitar_wav_48k_4s.json')
            with open(a_json, 'r') as f:
                music_guitar_infos2 = json.load(f)
           
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/20240223_bilibili_guitar_48k_4s.json')
            with open(a_json, 'r') as f:
                music_guitar_infos3 = json.load(f)
            #music_guitar_infos = music_guitar_infos1 + music_guitar_infos2 + music_guitar_infos3
            
            
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/20240221_bilibili_bass_48k_4s.json')
            with open(a_json, 'r') as f:
                music_bass_infos = json.load(f)
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/20240221_bilibili_bass_drum_48k_4s.json')
            with open(a_json, 'r') as f:
                music_drums_infos = json.load(f)
            
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/instrument_0225/flute_split.json')
            with open(a_json, 'r') as f:
                music_flute_infos = json.load(f)
            
            a_json = os.path.join('/home/sr5/xi5.chen/2sep_chenxi/2sep_envs/data_3sep_filtered_part/sax_split.json')
            with open(a_json, 'r') as f:
                music_sax_infos = json.load(f)
            
            a_json = os.path.join('/home/sr5/xi5.chen/2sep_chenxi/2sep_envs/data_3sep_filtered_part/Symphony_split.json')
            with open(a_json, 'r') as f:
                music_Symphony_infos = json.load(f)
            
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/instrument_0225/trump_split.json')
            with open(a_json, 'r') as f:
                music_trump_infos = json.load(f)
                
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/instrument_0225/tuba_split.json')
            with open(a_json, 'r') as f:
                music_tuba_infos = json.load(f)    
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/20240301_mrj_48k_4s.json')
            with open(a_json, 'r') as f:
                volins_infos = json.load(f)
                
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/separation3/slakh.json')
            with open(a_json, 'r') as f:
            ...
            ### vocal
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/musicdb_48k_4s/json/train/vocal.json')
            with open(a_json, 'r') as f:
                 musicdb_vocal_indos = json.load(f)
            a_json = os.path.join('/home/sr5/xi5.chen/2sep_chenxi/2sep_envs/data_3sep_filtered_part/songs_acapella_split_checked.json')
            with open(a_json, 'r') as f:
                songs_acapella_infos = json.load(f)   
            
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/songs_blibli.json')
            with open(a_json, 'r') as f:
                songs_bili_infos = json.load(f)
            
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/chorus_vocal/EsmucChoirDataset_split.json')
            with open(a_json, 'r') as f:
                EsmucChoirDataset_infos = json.load(f)
                
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/0205_vocals_split.json')
            with open(a_json, 'r') as f:
            ...
            ### noise
            a_json = os.path.join('/home/sr5/xi5.chen/2sep_chenxi/2sep_envs/data_3sep_filtered_part/dns_2022_noise.json')
            with open(a_json, 'r') as f:
                dns_infos = json.load(f) ##28014
                
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/babble_48k_4s.json')
            with open(a_json, 'r') as f:
                babble_infos = json.load(f)
                
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/wind_48k.json')
            with open(a_json, 'r') as f:
                wind_infos = json.load(f)
                                                                        
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/TV_noise/48k/effect_sound48k.json')
            with open(a_json, 'r') as f:
                movie_effect_sound_infos = json.load(f)
            
            a_json = os.path.join('/home/sr5/xi5.chen/2sep_chenxi/2sep_envs/data_3sep_filtered_part/Movie_remove_human_voice_48k_4s.json')
            with open(a_json, 'r') as f:
                movie_noise_infos1 = json.load(f)
            
            a_json = os.path.join('/home/sr5/xi5.chen/2sep_chenxi/2sep_envs/data_3sep_filtered_part/20240130_movie_remove_human_voice_48k_4s.json')
            with open(a_json, 'r') as f:
                movie_noise_infos2 = json.load(f)
            movie_noise_infos = movie_noise_infos1 + movie_noise_infos2
                    
            a_json = os.path.join('/home/sr5/xi5.chen/2sep_chenxi/2sep_envs/data_3sep_filtered_part/movie_trailer_split.json')
            with open(a_json, 'r') as f:
                movie_trailer_infos = json.load(f)
                
            a_json = os.path.join('/home/sr5/xi5.chen/mengruijie/data/3sep/home/sr5/ruijie.meng/data/separation3/noise_split.json')
            with open(a_json, 'r') as f:
...
#            ### noise 74611  ; voice : 181990;  15347
            ...
            sorted_vocal_infos = vocal_infos+vocal_infos+vocal_infos+vocal_infos+vocal_infos+vocal_infos+vocal_infos+vocal_infos+vocal_infos+vocal_infos+vocal_infos+vocal_infos+vocal_infos+vocal_infos
...
#                mixtures.append(noisy[i:i+segment_len])
#                sources.append(s[i:i+segment_len])
#            if utt_len % segment_len != 0:
#                mixtures.append(noisy[-segment_len:])
#                sources.append(s[-segment_len:])
#        else:  # full utterance
#            mixtures.append(noisy)
#            sources.append(s)

    #print('****************************',len(noisy),s.shape,segment_len)
        segment_len = 4*48000
